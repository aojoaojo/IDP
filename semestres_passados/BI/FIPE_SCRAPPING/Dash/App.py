...
fig_quantidade_modelos = px.bar(top_marcas, x=top_marcas['fevereiro de 2024'].keys(), y=top_marcas['fevereiro de 2024'].values(), title='Quantidade de modelos por marca (fevereiro de 2024)')
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Dropdown(
                            ...
                            options=['Todas as faixas de preço','0 a 15 mil', '15 a 50mil', '50 a 100mil', '100 a 200mil', '200 a 500mil', '500 a 1 milhão', '1 milhão ou mais'],
...
def update_table(mes1, mes2, valorizacao_desvalorizacao, faixa_preco):
    ...
    elif faixa_preco == '1 milhão ou mais':
